...
namespace Lab2
{
        ...
        private static void Stock_Vedomost(object sender, EventArgs e)
        {
        ...
        class Decanat : IObservable
        {
            ...
            public Decanat(IReadOnlyList<IObserver> student)
            {
                ...
                Vedomost += NotifyObservers;
                VedomostHead += NotifyObservers;
                Seccion += NotifyObservers;
            ...
            public delegate void VedomostHandler();
            public event VedomostHandler Vedomost;
            ...
            public  VedomostHandler VedomostHead;
            ...
            public event VedomostHandler Seccion;
